...
use crate::core::persistence::metrics::container::day::{
...
/// Aggregates minute-level data into dayly data for all given containers.
fn process_all_containers<R: MetricContainerDayProcessorRepository>(
    repo: &R,
